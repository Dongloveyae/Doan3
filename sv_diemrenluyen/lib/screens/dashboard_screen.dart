            ...
            MaterialPageRoute(
              builder: (context) => EventDetailScreen(
                event: {
                  ...
                  'max_participants': activity['max_participants'] ?? 0, // Thêm dòng này
                  'current_participants': activity['current_participants'] ?? 0, // Thêm dòng này
                  
                  // ĐÃ BỔ SUNG: Truyền dữ liệu chỉ tiêu ngành từ API trang chủ sang trang chi tiết
