...
// -----------------------------------------------------------------
// Kiểm tra trong danh sách lịch sử nộp minh chứng xem sự kiện này đã có bản ghi chưa
...
if (existingHistory != null) {
  ...
  bool isCountByTurn = e['score_type'] == 'multiple';
...
if (widget.initialCategory != null || _selectedEventId != null)
  ...
  _isLoadingCategories 
    ? const Center(child: CircularProgressIndicator(color: Color(0xFF0D235E)))
    : DropdownButtonFormField<String>(
        // --- SỬA TẠI ĐÂY: Bảo vệ chống crash nếu mã danh mục không khớp với Tên hiển thị ---
